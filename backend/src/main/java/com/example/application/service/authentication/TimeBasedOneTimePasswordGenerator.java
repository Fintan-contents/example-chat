...
public final class TimeBasedOneTimePasswordGenerator {
    ...
    private TimeBasedOneTimePasswordGenerator(final Builder builder) {
        this.generator = HmacBasedOneTimePasswordGenerator.builder().algorithm(builder.algorithm).digit(builder.digit)
                .build();
        this.x = builder.x;
        this.t0 = builder.t0;
    }
    ...
    public static final class Builder {
        ...
        public Builder timeStepInSeconds(final long x) {
            this.x = x;
            return this;
        }

        public Builder unixTimeToStartCounting(final long t0) {
            this.t0 = t0;
            return this;
        }
