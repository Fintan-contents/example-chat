...
public class LoginCheckHandler implements Handler<HttpRequest, Object> {
    ...
    public LoginCheckHandler() {
        ...
        whitePatterns
                ...
                .add("/api/signup/verify", HttpMethod.POST)
                .add("/api/login", HttpMethod.POST)
                .add("/api/2fa", HttpMethod.POST)
                .add("/api/reset_password", HttpMethod.POST)
                .add("/api/reset_password/**", HttpMethod.ALL)
                .add("/api/systeminfo/messages", HttpMethod.GET)
