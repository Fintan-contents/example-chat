...
import com.example.presentation.restapi.channel.ChannelNameSettingAction.ChannelPutRequest;

public class ChannelPutRequestTest {

    @RegisterExtension
    static ValidationExtension validation = new ValidationExtension();

    private ChannelPutRequest sut = new ChannelPutRequest();
